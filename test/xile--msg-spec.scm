...
(check (cdr (xile-msg-init)) => "{\"method\":\"client_started\"}" )
...
(check (cdr (xile-msg-edit-insert "test_view")) => "{\"id\":3,\"method\":\"edit\",\"params\":{\"method\":\"insert\",\"view_id\":\"test_view\"}}")
(check (cdr (xile-msg-edit-insert "test_view" #:chars "")) => "{\"id\":4,\"method\":\"edit\",\"params\":{\"method\":\"insert\",\"view_id\":\"test_view\",\"params\":{\"chars\":\"\"}}}")
(check (cdr (xile-msg-edit-paste "test_view" #:chars "password")) => "{\"id\":5,\"method\":\"edit\",\"params\":{\"method\":\"paste\",\"view_id\":\"test_view\",\"params\":{\"chars\":\"password\"}}}")
(check (cdr (xile-msg-edit-move_right "test_view")) => "{\"id\":6,\"method\":\"edit\",\"params\":{\"method\":\"move_right\",\"view_id\":\"test_view\"}}")
